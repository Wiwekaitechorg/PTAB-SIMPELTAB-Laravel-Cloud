...
class AbsenceApiController extends Controller
{
    ...
    public function report(Request $request)
    {
        ...
        if ($request->type != "shift") {
            ...
            $alpha = $jumlah_kerja - $report->jumlah_masuk - $report->jumlah_dinasLuar - $report->jumlah_cuti - $izin->jumlah_izin - $report->jumlah_dispen - $sakit->jumlah_sakit;
            $kegiatan = "Kegiatan";
        } else {
        ...
        $data = [
            ...
            ["title" => "Jumlah dinas luar", "data"  => $report->jumlah_dinasLuar],
            ["title" => "Jumlah cuti", "data"  => $report->jumlah_cuti],
            ["title" => "Jumlah lembur", "data"  => $report->jumlah_lembur],
