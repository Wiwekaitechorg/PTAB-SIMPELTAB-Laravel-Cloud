...

{
...

    {
        ...
        ')
            ...
            ->whereRaw("DATE(proposal_wms.created_at) >= '".date('Y-m-21', strtotime('-1 month', strtotime($request->monthyear)))."' AND DATE(proposal_wms.created_at) <= '".date('Y-m-20', strtotime('0 month', strtotime($request->monthyear)))."'")
