...
class SuratSegelController extends Controller
{
    public function suratPdf(Request $request)
    {
        ...
        // dd($recap);
        $dataPembayaran = $ctm[$key]->tglbayarterakhir;
        $dataPembayaran1 = $ctm[$key - $jmlTunggakan]->tglbayarterakhir;
        // tglbayarterakhir
        // dd($recap);
        ...
        $firstBulan = $monthList[date('n', strtotime($dataPembayaran1))];
        $lastBulan = $monthList[date('n', strtotime($dataPembayaran))];
