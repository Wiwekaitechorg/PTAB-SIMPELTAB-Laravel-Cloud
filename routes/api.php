...
//complains
Route::group(['prefix' => 'open/complain', 'namespace' => 'Api\V1\Complain'], function () {
    Route::post('login', 'ComplainsApiController@login');
    Route::post('login-new', 'ComplainsApiController@loginNew');
});
Route::group(['prefix' => 'close/complain', 'namespace' => 'Api\V1\Complain', 'middleware' => 'auth:apiadmin'], function () {   
    Route::post('list', 'ComplainsApiController@list');
    //complains
    Route::post('store', 'ComplainsApiController@store');
    Route::post('detail', 'ComplainsApiController@detailComplain');
    Route::get('complainstatus', 'ComplainsApiController@complainstatus');
    Route::get('areas', 'ComplainsApiController@areas');
    Route::get('customer/{code}', 'ComplainsApiController@customer');
    Route::post('delete', 'ComplainsApiController@destroy');
    Route::post('close', 'ComplainsApiController@close');
    Route::post('action/list', 'ComplainsApiController@actionlist');
    Route::post('action/store', 'ComplainsApiController@actionstore');
    Route::post('action/detail', 'ComplainsApiController@actiondetail');
    Route::post('action/update', 'ComplainsApiController@actionupdate');
    Route::post('action/delete', 'ComplainsApiController@actionDestroy');
    Route::post('check/list', 'ComplainsApiController@checklist');
    Route::post('check/store', 'ComplainsApiController@checkstore');
    Route::post('check/detail', 'ComplainsApiController@checkdetail');
    Route::post('check/update', 'ComplainsApiController@checkupdate');
    Route::post('check/delete', 'ComplainsApiController@checkDestroy');
    Route::post('ticket/store', 'ComplainsApiController@ticketStore');
});
Route::group(['prefix' => 'close/complainpbk', 'namespace' => 'Api\V1\Complain', 'middleware' => 'auth:apipbk'], function () {   
    Route::post('list', 'ComplainsApiController@list');
    Route::post('complainOpp', 'ComplainsApiController@complainOpp');
    //complains
    Route::post('store', 'ComplainsApiController@store');
    Route::post('detail', 'ComplainsApiController@detailComplain');
    Route::get('complainstatus', 'ComplainsApiController@complainstatus');
...
// sementara
Route::group(['prefix' => 'open/absence', 'namespace' => 'Api\V1\Absence'], function () {
    Route::post('loginAdmin', 'UserApiController@loginAdmin');
    Route::post('login', 'UserApiController@login');
    Route::post('loginComplain', 'UserApiController@loginComplain');
    Route::get('reportAbsenceExcel', 'AbsenceApiController@reportAbsenceExcel');
    ...
    Route::get('test-tmp', 'AbsenceApiController@index_service');
});
...
Route::group(['prefix' => 'close/absence', 'namespace' => 'Api\V1\Absence'], function () {  
    //get user
    Route::get('user/{id}', 'AbsenceApiController@user');
    ...
    Route::post('loginAdmin', 'UserApiController@loginAdmin');
    Route::post('loginAdminoff', 'UserApiController@loginAdminoff');
    Route::post('loginAdminbyid', 'UserApiController@loginAdminbyid');
    ...
    Route::get('requests/getPermissionCatNew', 'RequestApiController@getPermissionCatNew');
    ...
    Route::post('absence/storeLocationNew', 'AbsenceApiController@storeLocationNew');
...
Route::group(['prefix' => 'close/visit', 'namespace' => 'Api\V1\Visit'], function () {
    ...
    Route::get('getDataCbox', 'VisitApiController@getDataCbox');
    Route::get('getDataStaff', 'VisitApiController@getDataStaff');
    Route::post('storeEtc', 'VisitApiController@storeEtc');
    Route::get('getHistory', 'VisitApiController@getHistory');
});


Route::group(['prefix' => 'open/wablast', 'namespace' => 'Api\V1'], function () {
    Route::post('callback', 'WaBlastCallbackApiController@callback');
});
