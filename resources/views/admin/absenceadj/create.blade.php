...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.absenceadj.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group {{ $errors->has('staff_id') ? 'has-error' : '' }}">
                    ...
                    <select id="staff_id" name="staff_id" class="form-control select2"
                        value="{{ old('staff_id', isset($shift_staff) ? $shift_staff->staff_id : '') }}" required>
                ...
                <div class="form-group {{ $errors->has('session_start') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="session_start" name="session_start" class="form-control"
                        value="{{ old('session_start', isset($duty) ? $duty->session_start : '') }}" required>
                ...
                <div class="form-group {{ $errors->has('session_end') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="session_end" name="session_end" class="form-control"
                        value="{{ old('session_end', isset($duty) ? $duty->session_end : '') }}" required>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Masuk') ? 'has-error' : '' }}">
                    <label for="Jumlah_Masuk"
                        id="Jumlah_Masuk_Label">{{ trans('global.absenceadj.fields.Jumlah_Masuk') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Kegiatan1') ? 'has-error' : '' }}">
                    <label for="Jumlah_Kegiatan1"
                        id="Jumlah_Kegiatan1_Label">{{ trans('global.absenceadj.fields.Jumlah_Kegiatan1') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Kegiatan2') ? 'has-error' : '' }}">
                    <label for="Jumlah_Kegiatan2"
                        id="Jumlah_Kegiatan2_Label">{{ trans('global.absenceadj.fields.Jumlah_Kegiatan2') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Dinas_Dalam') ? 'has-error' : '' }}">
                    <label for="Jumlah_Dinas_Dalam"
                        id="Jumlah_Dinas_Dalam_Label">{{ trans('global.absenceadj.fields.Jumlah_Dinas_Dalam') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Dinas_Luar') ? 'has-error' : '' }}">
                    <label for="Jumlah_Dinas_Luar"
                        id="Jumlah_Dinas_Luar_Label">{{ trans('global.absenceadj.fields.Jumlah_Dinas_Luar') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Cuti') ? 'has-error' : '' }}">
                    <label for="Jumlah_Cuti"
                        id="Jumlah_Cuti_Label">{{ trans('global.absenceadj.fields.Jumlah_Cuti') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Lembur') ? 'has-error' : '' }}">
                    <label for="Jumlah_Lembur"
                        id="Jumlah_Lembur_Label">{{ trans('global.absenceadj.fields.Jumlah_Lembur') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Lembur4') ? 'has-error' : '' }}">
                    <label for="Jumlah_Lembur4"
                        id="Jumlah_Lembur4_Label">{{ trans('global.absenceadj.fields.Jumlah_Lembur4') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Permisi') ? 'has-error' : '' }}">
                    <label for="Jumlah_Permisi"
                        id="Jumlah_Permisi_Label">{{ trans('global.absenceadj.fields.Jumlah_Permisi') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Izin') ? 'has-error' : '' }}">
                    <label for="Jumlah_Izin"
                        id="Jumlah_Izin_Label">{{ trans('global.absenceadj.fields.Jumlah_Izin') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Sakit') ? 'has-error' : '' }}">
                    <label for="Jumlah_Sakit"
                        id="Jumlah_Sakit_Label">{{ trans('global.absenceadj.fields.Jumlah_Sakit') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Dispen') ? 'has-error' : '' }}">
                    <label for="Jumlah_Dispen"
                        id="Jumlah_Dispen_Label">{{ trans('global.absenceadj.fields.Jumlah_Dispen') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Alfa') ? 'has-error' : '' }}">
                    <label for="Jumlah_Alfa"
                        id="Jumlah_Alfa_Label">{{ trans('global.absenceadj.fields.Jumlah_Alfa') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Tidak_Masuk') ? 'has-error' : '' }}">
                    <label for="Jumlah_Tidak_Masuk"
                        id="Jumlah_Tidak_Masuk_Label">{{ trans('global.absenceadj.fields.Jumlah_Tidak_Masuk') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Hari_Kerja') ? 'has-error' : '' }}">
                    <label for="Jumlah_Hari_Kerja"
                        id="Jumlah_Hari_Kerja_Label">{{ trans('global.absenceadj.fields.Jumlah_Hari_Kerja') }}</label>
                ...
                <div class="form-group {{ $errors->has('Jumlah_Hari_Libur') ? 'has-error' : '' }}">
                    <label for="Jumlah_Hari_Libur"
                        id="Jumlah_Hari_Libur_Label">{{ trans('global.absenceadj.fields.Jumlah_Hari_Libur') }}</label>
                ...
                <div class="form-group {{ $errors->has('Absen_Bolong_Datang') ? 'has-error' : '' }}">
                    <label for="Absen_Bolong_Datang"
                        id="Absen_Bolong_Datang_Label">{{ trans('global.absenceadj.fields.Absen_Bolong_Datang') }}</label>
                ...
                <div class="form-group {{ $errors->has('Absen_Bolong_Pulang') ? 'has-error' : '' }}">
                    <label for="Absen_Bolong_Pulang"
                        id="Absen_Bolong_Pulang_Label">{{ trans('global.absenceadj.fields.Absen_Bolong_Pulang') }}</label>
                ...
                <div class="form-group {{ $errors->has('Absen_Lambat') ? 'has-error' : '' }}">
                    <label for="Absen_Lambat"
                        id="Absen_Lambat_Label">{{ trans('global.absenceadj.fields.Absen_Lambat') }}</label>
                ...
                <div class="form-group {{ $errors->has('Permisi_Potong_Gaji') ? 'has-error' : '' }}">
                    <label for="Permisi_Potong_Gaji"
                        id="Permisi_Potong_Gaji_Label">{{ trans('global.absenceadj.fields.Permisi_Potong_Gaji') }}</label>
                ...
                <div class="form-group {{ $errors->has('Permisi_Tidak_Potong_Gaji') ? 'has-error' : '' }}">
                    <label for="Permisi_Tidak_Potong_Gaji"
                        id="Permisi_Tidak_Potong_Gaji_Label">{{ trans('global.absenceadj.fields.Permisi_Tidak_Potong_Gaji') }}</label>
