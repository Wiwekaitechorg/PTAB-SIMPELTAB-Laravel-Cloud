        ...
        <div class="v103_240">
            <div class="A1Text">
               <span class="v103_243"></span>
                ...
                <span class="v103_259">{{$ticket->customer ? $ticket->customer->name:''}}</span>
                <span class="v103_260"> @if ($ticket->address != null){{$ticket->address}}@endif  @if ($ticket->address == null){{$ticket->customers ? $ticket->customer->address:''}}@endif</span>
                <span class="v103_261">{{$ticket->customer ? $ticket->customer->code:''}}</span>
                <span class="v103_262">{{$ticket->customer ? $ticket->customer->name:''}}</span>
