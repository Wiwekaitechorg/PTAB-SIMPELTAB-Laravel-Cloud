...
<div class="card">
    ...
    <div class="card-body">
        <form check="{{ route('admin.checks.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                <label for="code">{{ trans('global.check.fields.code') }}*</label>
                <input type="text" id="code" name="code" class="form-control" value="{{ old('code', isset($check) ? $check->code : '') }}">
                @if($errors->has('code'))
            ...
            <div class="form-group {{ $errors->has('ticket') ? 'has-error' : '' }}">
                <label for="ticket">{{ trans('global.check.fields.ticket') }}*</label>
            ...
            <div class="form-group {{ $errors->has('dapertement') ? 'has-error' : '' }}">
                <label for="dapertement">{{ trans('global.check.fields.dapertement') }}*</label>
