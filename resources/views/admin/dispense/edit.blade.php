...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.dispense.update", $requests->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('end') ? 'has-error' : '' }}">
                <label for="end">{{ trans('global.dispense.fields.end') }}*</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.dispense.fields.end_helper') }}
                </p>
            </div>
