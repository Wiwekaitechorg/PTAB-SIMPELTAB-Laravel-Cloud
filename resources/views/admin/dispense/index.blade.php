...
<div class="card">
    ...
    <div class="card-header">
        {{ trans('global.dispense.title_singular') }} {{ trans('global.list') }}
    </div>
    <div class="card-body">
    <div class="form-group">
             ...
             <form action="" id="filtersForm">
                ...
                <div class="col-md-6">
                    ...
                    <select id="category" name="category" class="form-control">
                        ...
                        <option value="dispense">Dispensasi</option>
        ...
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable ajaxTable datatable-dispense">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        {{-- <th>
                            {{ trans('global.dispense.fields.id') }}
                        </th> --}}
                        <th>
                        ...
                        <th>
                            {{ trans('global.dispense.fields.type') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('global.dispense.fields.created_at') }}
                        </th>
                   
                        {{-- <th>
                            {{ trans('global.dispense.fields.upstartd_at') }}
                        </th> --}}
                        <th>
                            &nbsp;
                        </th>
...
<script>
  ...
  let dtOverrideGlobals = {
    ...
    aaSorting: [],
    ajax: {
      url: "{{ route('admin.dispense.index') }}",
      data: {
  ...
  $('.datatable-dispense').DataTable(dtOverrideGlobals);
