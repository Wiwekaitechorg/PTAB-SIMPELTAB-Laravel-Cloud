...
<body onload="onload()" >
    <img src="{{url('/')."images/QRCodeSimTab.png" }}" alt="" style="height: 100px; margin-left: 800px; ">
    <br>
    <img src="{{url('/')."images/kopSuratPDAM.PNG" }}" alt="" style="width: 800px; height: 200px; ">
    {{-- <div class="title">
   ...
   <div class="row">
        ...
        <div class="column">
            Tabanan, {{$complain->created_at->format('d/m/Y')}}
            <br>
