...
<body onload="onload()" >
   ...
   <div class="row">
        ...
        <div class="column">
            Tabanan, {{$proposalWm->created_at->format('d/m/Y')}}
            <br>
            ...
            <br>
            <br>
            {{ $proposalKa->users?$proposalKa->users->name : '' }}
            <br>
            <hr style="width: 60%">
            Nik. 10.09
        </div>
    ...
    <br>
    <img src="{{ "https://simpletabadmin.ptab-vps-storage.com/images/QRCodeSimTab.png" }}" alt="" style="height: 100px; margin-left: 700px; ">
<script>
    onload = function (){
        window.print();
    }
