...
@can('check_staff_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.checkstaffs.create', $check->id) }}">
                ...
                @foreach($check->staff as $key => $staff)
                        <tr data-entry-id="{{ $staff->id }}">
                            ...
                            <td>
                                ...
                                @endcan
                                @can('staff_delete')
                                    <form check="{{ route('admin.staffs.destroy', $staff->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
